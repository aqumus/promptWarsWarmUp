...
<required_reading>
Read `/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/gsd-core/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>

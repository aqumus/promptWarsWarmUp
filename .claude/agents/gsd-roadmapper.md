...
Reference full template: `/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/gsd-core/templates/state.md`.

...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/.gsd-surface.json`
(sibling to `/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/skills`).
...
`/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/.gsd-surface.json`
Install profile marker: `/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/.gsd-profile`
Skill dirs: `/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/skills/gsd-*/`
Engine module: `/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>

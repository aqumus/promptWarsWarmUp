...
The keys live in `.claude/settings.json` (project) or `/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/settings.json` (global) — **not** in `.planning/config.json`:

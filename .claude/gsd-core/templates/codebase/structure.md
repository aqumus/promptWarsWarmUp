...
- Usage: Reference from command with `@/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

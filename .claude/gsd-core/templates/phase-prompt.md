...
<!-- For checkpoint task examples and patterns, see @/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/gsd-core/references/checkpoints.md -->
...
See `/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/gsd-core/workflows/verify-phase.md` for verification logic.

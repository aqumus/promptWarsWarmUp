...
<required_reading>
@/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/gsd-core/references/ai-frameworks.md
@/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/agents/gsd-eval-planner.md for instructions.

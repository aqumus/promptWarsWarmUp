...
- **Global scope**: `/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/notes/`)
...
2. Glob `/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/notes/` — works in any directory

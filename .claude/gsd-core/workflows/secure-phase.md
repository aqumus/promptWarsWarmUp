...
```
Agent(
  prompt="Read /Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/gsd-core/templates/SECURITY.md`

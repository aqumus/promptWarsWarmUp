...
INSTALL_JS_GLOBAL="/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.

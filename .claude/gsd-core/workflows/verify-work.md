...
<template>
@/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/gsd-core/workflows/transition.md`.
...
- Follow @/Users/aquibvadsaria/project/playground/promptWarsWarmUp/.claude/gsd-core/workflows/diagnose-issues.md
